...
const file_proto_message_proto_rawDesc = "" +
	"\n" +
	"\x13proto/message.proto\x12\amessage\"5\n" +
	"\aMessage\x12\x16\n" +
	...
	"\vMessageList\x12,\n" +
	"\bmessages\x18\x01 \x03(\v2\x10.message.MessageR\bmessages2q\n" +
	"\fMessageStore\x12(\n" +
	"\x04Save\x12\x10.message.Message\x1a\x0e.message.Empty\x127\n" +
	"\tGetLast10\x12\x14.message.UserRequest\x1a\x14.message.MessageListB\tZ\a./protob\x06proto3"
...
var file_proto_message_proto_goTypes = []any{
	...
	(*Empty)(nil),       // 1: message.Empty
	(*UserRequest)(nil), // 2: message.UserRequest
	(*MessageList)(nil), // 3: message.MessageList
}
var file_proto_message_proto_depIdxs = []int32{
	0, // 0: message.MessageList.messages:type_name -> message.Message
	0, // 1: message.MessageStore.Save:input_type -> message.Message
	2, // 2: message.MessageStore.GetLast10:input_type -> message.UserRequest
	1, // 3: message.MessageStore.Save:output_type -> message.Empty
	3, // 4: message.MessageStore.GetLast10:output_type -> message.MessageList
